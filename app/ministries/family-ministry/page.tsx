...
export default function FamilyMinistryPage() {
  const missionPoints = [
    "Strengthen families through biblical teaching and Christ-centered encouragement.",
    "Support marriages, parents, and children in every season of life.",
    "Create opportunities for families to worship, pray, and grow together.",
    "Build a caring community where families can find connection and support.",
    "Equip parents to lead their homes in faith and love.",
    "Encourage healthy, faithful, and God-honoring family life.",
  ];
    ...
    <main className="bg-white text-slate-900">
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-28 md:px-10 md:py-36">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/75">
            Strengthening homes and encouraging families to grow together in
            Christ.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#433352] px-6 py-24 text-white md:px-10 md:py-28">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-5 text-lg italic text-purple-200">Joshua 24:15</p>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <aside className="flex h-fit flex-col rounded-[28px] bg-gradient-to-br from-purple-600 to-purple-700 p-8 shadow-2xl md:p-10">
              ...
              <div className="mt-8 rounded-2xl bg-white/10 p-4 text-sm text-white/85">
                For marriage, parenting, or family support questions, please
                reach out to us.
              </div>
            </aside>
          </div>
