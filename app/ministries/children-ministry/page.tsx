...
export default function ChildrenMinistryPage() {
  const missionPoints = [
    "Create a safe and joyful environment where children can learn about Jesus.",
    "Teach God’s Word in ways children can understand and apply.",
    "Help children grow in prayer, worship, and Christian character.",
    "Partner with parents in raising children in faith.",
    "Encourage friendship, kindness, and a love for the church community.",
    "Lay a strong spiritual foundation for the next generation.",
  ];
    ...
    <main className="bg-white text-slate-900">
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-28 md:px-10 md:py-36">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/75">
            Helping children know God, grow in faith, and experience His love in
            a joyful way.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#433352] px-6 py-24 text-white md:px-10 md:py-28">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-5 text-lg italic text-purple-200">Matthew 19:14</p>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <aside className="flex h-fit flex-col rounded-[28px] bg-gradient-to-br from-purple-600 to-purple-700 p-8 shadow-2xl md:p-10">
              ...
              <div className="mt-8 rounded-2xl bg-white/10 p-4 text-sm text-white/85">
                Reach out for children&apos;s classes, age groups, and family
                support information.
              </div>
            </aside>
          </div>
