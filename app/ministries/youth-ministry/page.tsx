...
export default function YouthMinistryPage() {
  const missionPoints = [
    "Help young people know Jesus personally and grow in faith.",
    "Create a vibrant community for worship, learning, and friendship.",
    "Encourage youth to live boldly for Christ in everyday life.",
    "Provide mentoring, discipleship, and spiritual guidance.",
    "Build leadership, character, and service-minded hearts.",
    "Equip the next generation to impact church, school, and community.",
  ];
    ...
    <main className="bg-white text-slate-900">
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-28 md:px-10 md:py-36">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/75">
            Raising a generation of young believers who know Christ and live for
            Him.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#433352] px-6 py-24 text-white md:px-10 md:py-28">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-5 text-lg italic text-purple-200">1 Timothy 4:12</p>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <aside className="flex h-fit flex-col rounded-[28px] bg-gradient-to-br from-purple-600 to-purple-700 p-8 shadow-2xl md:p-10">
              ...
              <div className="mt-8 rounded-2xl bg-white/10 p-4 text-sm text-white/85">
                For youth gatherings, mentorship, or events, please contact us.
              </div>
            </aside>
          </div>
        </div>
