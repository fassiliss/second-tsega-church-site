...
export default function WomensMinistryPage() {
  const missionPoints = [
    "Join a welcoming and supportive community of women.",
    "Open to women of all ages and backgrounds.",
    "Connect through prayer, fellowship, and study of God’s Word.",
    "Build strong relationships and find support through life’s challenges.",
    "Receive encouragement and spiritual nourishment to help you thrive.",
    "Grow in faith alongside other women who share your passion for God.",
  ];
    ...
    <main className="bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-28 md:px-10 md:py-36">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/75">
            Growing together in faith, prayer, and fellowship as women of God.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#433352] px-6 py-24 text-white md:px-10 md:py-28">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-5 text-lg italic text-purple-200">Proverbs 31:25</p>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <aside className="flex h-fit flex-col rounded-[28px] bg-gradient-to-br from-purple-600 to-purple-700 p-8 shadow-2xl md:p-10">
              ...
              <div className="mt-8 rounded-2xl bg-white/10 p-4 text-sm text-white/85">
                For ministry questions, fellowship opportunities, or prayer
